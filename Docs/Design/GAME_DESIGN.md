...
tags:
  ...
  - spec
---
# 비주얼 노벨 게임 엔진 — 기획 및 설계 문서

> **프로젝트**: Voradorix  
> **엔진**: SFML 3.1.0 (C++17, Visual Studio 2022 x64)  
> **작성일**: 2026-06-30  
> **최종 갱신**: 2026-07-10 (프로젝트 방향 전환 반영)
>
> **📌 방향 전환 안내:** 이 문서는 **엔진 런타임**의 설계를 설명합니다.
> 에디터(Electron)에 대한 설계는 [[Design/PROJECT_DIRECTION.md]] 참조.
> 게임 콘텐츠 개발보다 엔진+에디터 개발이 우선순위입니다.
